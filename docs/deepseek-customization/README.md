...
PATH="$HOME/.bun/bin:$PATH" bun test test/session/instruction.test.ts
PATH="$HOME/.bun/bin:$PATH" bun test test/session/compaction.test.ts
PATH="$HOME/.bun/bin:$PATH" bun test test/tool/summarize.test.ts test/tool/shell.test.ts --test-name-pattern 'summarizeToolOutput|error_summary'
